        ...
        <div class="mb-4 w-50">
          <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
              ...
              <li class="breadcrumb-item">
                <router-link to="/transaksi"> <a href=""> Transaksi </a> </router-link>
              </li>
        ...
        <div class="card">
          <div>
            <table class="table align-items-center mb-0">
              ...
              <!-- Input Tanggal Transaksi And Lama Pengerjaan -->
              <div class="row">
                ...
                <div class="col-md-4 pl-1">
                  <div class="form-group">
                    ...
                    <input type="number" class="form-control-soft" placeholder="Lama Pengerjaan"
                      v-model="lama_pengerjaan">
                  </div>
                </div>
              </div>

              <!-- Input Item from Paket -->
              <div class="form-group">
                <p class="col-form-label"> Item </p>
                <b-button @click="addItem" size="sm" variant="warning"><i class="mdi mdi-plus btn-icon-prepend"></i>
                  Tambah Item</b-button>
                <br><br>
                <div class="row" v-for="(detail, counter) in detailtransaksi" v-bind:key="counter">
                  <br><br>
                  ...
                  <div class="col-md-4">
                    <div class="form-group">
                      <b-form-select class="form-control-soft" v-model="detail.id_paket" :options="data_paket">
                      </b-form-select>
                    </div>
                  </div>
  ...
  module.exports = {
    ...
    methods: {
      ...
      Save: function() {
        ...
        // Get ID User
        axios.get(base_url + "login/check", conf).then(response => {
          if (response.data.success == false) {
            ...
            axios.post(base_url + "transaksi", form, conf).then(response2 => {
