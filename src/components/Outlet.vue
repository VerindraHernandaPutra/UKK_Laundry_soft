<template>
    ...
    <div class="update ml-auto mr-auto">
        <button v-b-tooltip.hover.bottom title="Tambah Outlet" class="btn bg-gradient-success w-auto me-2" v-b-modal.modal_outlet @click="Add()" > <i class="fa-solid fa-shop fa-fw fa-lg"></i> + </button>
    </div>
      ...
      <tbody>
        <tr v-for="out in outlet" :key="out">
          ...
          <td class="align-middle text-center">
            <a v-b-modal.modal_outlet class="btn bg-gradient-info w-auto me-1 mb-0" @click="Edit(out)" v-b-tooltip.hover.bottom title="Ubah Outlet" > <i class="fa-solid fa-pen-to-square"></i></a>
            <a class="btn bg-gradient-danger w-auto me-1 mb-0" @click="Delete(out.id_outlet)" v-b-tooltip.hover.bottom title="Delete Outlet" > <i class="fa-solid fa-shop-slash"></i></a>
          </td>
          <div class="container">
</div>
        </tr>
...
<b-modal class="modal fade" id="modal_outlet" ref="modal" title="Form Outlet" aria-labelledby="exampleModalLabel" aria-hidden="true" size="md" hide-footer hide-header-close>
          <form>
           <div class="row">
             <div class="col-md-12">
                <div class="form-group">
                  <label>Nama Outlet</label>
                  <input v-model="nama_outlet" id="inputOutlet" type="text" class="form-control-soft" placeholder="Masukkan Outlet">
                  </div>
                </div>
             </div>
          ...
          <div class="row">
            <div class="update ml-auto mr-auto">
              ...
              <button block @click="$bvModal.hide('modal_outlet')" class="btn bg-gradient-dark w-auto me-2 pull-left"> Cancel </button>
            </div>                         
          </div>
        </form>
      </b-modal>
