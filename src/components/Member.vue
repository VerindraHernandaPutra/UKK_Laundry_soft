    ...
    <div class="container">
      <div class="row">
        ...
        <div class="update ml-auto mr-auto">
          <button v-b-tooltip.hover.bottom title="Tambah Member" class="btn bg-gradient-success w-auto me-2"
            v-b-modal.modal_member @click="Add()"> <i class="fa-solid fa-person-circle-plus fa-fw fa-lg"></i></button>
        </div>
              ...
              <tbody>
                <tr v-for="mem in member" :key="mem">
                  ...
                  <td class="align-middle text-center text-sm">
                    <h6>
                      <b-badge> <span class="badge bg-gradient-info "
                          v-if="mem.jenis_kelamin === 'Laki-laki'">Laki-Laki</span> </b-badge>
                    </h6>
                    <h6>
                      <b-badge> <span class="badge bg-gradient-warning"
                          v-if="mem.jenis_kelamin === 'Perempuan'">Perempuan</span> </b-badge>
                    </h6>
                  </td>
                  ...
                  <td class="align-middle text-center">
                    <a v-b-modal.modal_member class="btn bg-gradient-info w-auto me-1 mb-0" @click="Edit(mem)"
                      v-b-tooltip.hover.bottom title="Ubah Member"> <i class="fa-solid fa-pen-to-square"></i></a>
                    <a class="btn bg-gradient-danger w-auto me-1 mb-0" @click="Delete(mem.id_member)"
                      v-b-tooltip.hover.bottom title="Delete Member"> <i class="fa-solid fa-user-minus"></i></a>
                  </td>
                </tr>
              </tbody>
            </table>
        ...
        <!-- Form Modal -->
        <b-modal class="modal fade" id="modal_member" ref="modal" title="Form Member"
          ...
          <form>
            ...
            <div class="row">
              ...
              <div class="col-md-7 pl-1">
                <div class="form-group">
                  <label>Telepon</label>
                  <input v-model="telp" id="inputTlp" type="text" class="form-control-soft"
            ...
            <div class="row">
              <div class="col-md-12">
                <div class="form-group">
                  <label>Alamat</label>
                  <input v-model="alamat" id="inputAlamat" type="text" class="form-control-soft"
            ...
            <div class="row">
              <div class="update ml-auto mr-auto">
                ...
                <button block @click="$bvModal.hide('modal_member')" class="btn bg-gradient-dark w-auto me-2 pull-left">
                  Cancel </button>
              </div>
            </div>
    ...
    methods: {
      ...
      Save: function() {
        ...
        if (this.action == "insert") {
          ...
          // Update Method
          axios.put(base_url + 'member/' + this.id_member, form, config).then(response => {
