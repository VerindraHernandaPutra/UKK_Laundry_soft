        ...
        <div class="row">
            ...
            <div class="card card-plain">
              ...
              <div class="card-body">
                <form role="form" v-on:submit.prevent="login" class="pt-3" method="post">
                  <div class="mb-3">
                    <input v-model="username" class="form-control form-control-lg" id="username" type="text" placeholder="Username" aria-label="Username">
                  </div>
                  <div class="mb-3">
                    <input v-model="password" class="form-control form-control-lg" id="password" type="password" placeholder="Password" aria-label="Password">
                  </div>
          ...
          <div class="col-6 d-lg-flex d-none h-100 my-auto pe-0 position-absolute top-0 end-0 text-center justify-content-center flex-column">
            <div class="position-relative bg-gradient-info h-100 m-3 px-7 border-radius-lg d-flex flex-column justify-content-center">
              <img src="src/assets/img/shapes/pattern-lines.svg" alt="pattern-lines" class="position-absolute opacity-4 start-0">
              <div class="position-relative">
                <img class="max-width-500 w-100 position-relative z-index-2" src="src/assets/img/machine-of-death.png">
              </div>
              <h4 class="mt-5 text-white font-weight-bolder">Cycloundry</h4>
            ...
            axios.post(base_url + 'login',form)
                .then(response =>{
                    if (response.data.success == true) {
                        ...
                        swal.fire({title:"Error!", text: "Username atau Password Salah!", icon: "error",});
                    }
