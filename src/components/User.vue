<template>
    ...
    <div class="update ml-auto mr-auto">
        <button v-b-tooltip.hover.bottom title="Tambah User" class="btn bg-gradient-success w-auto me-2" v-b-modal.modal_user @click="Add()" > <i class="fa-solid fa-person-circle-plus fa-fw fa-lg"></i></button>
    </div>
      ...
      <tbody>
        <tr v-for="ser in user" :key="ser">
          ...
          <td class="align-middle text-center text-sm">
            <h6> <b-badge> <span class="badge bg-gradient-primary " v-if="ser.role === 'admin'">Admin</span> </b-badge> </h6>
            <h6> <b-badge> <span class="badge bg-gradient-secondary" v-if="ser.role === 'kasir'">Kasir</span> </b-badge> </h6>
            <h6> <b-badge> <span class="badge bg-gradient-dark" v-if="ser.role === 'owner'">Owner</span> </b-badge> </h6>
          </td>
          <td class="align-middle text-center">
            <span class="text-secondary text-xs font-weight-bold"> {{ ser.outlet.nama_outlet }} </span>
          </td>
          <td class="align-middle text-center">
            <a v-b-modal.modal_user class="btn bg-gradient-info w-auto me-1 mb-0" @click="Edit(ser)" v-b-tooltip.hover.bottom title="Ubah User" > <i class="fa-solid fa-pen-to-square"></i></a>
            <a class="btn bg-gradient-danger w-auto me-1 mb-0" @click="Delete(ser.id_user)" v-b-tooltip.hover.bottom title="Delete User" > <i class="fa-solid fa-user-minus"></i></a>
          </td>
          <div class="container">
</div>
        </tr>
...
<b-modal class="modal fade" id="modal_user" ref="modal" title="Form User" aria-labelledby="exampleModalLabel" aria-hidden="true" size="md" hide-footer hide-header-close>
          <form>
           <div class="row">
             <div class="col-md-12">
             ...
             <div class="col-md-12">
                <div class="form-group">
                  <label>Username</label>
                   <input v-model="username" id="inputUsername" type="text" class="form-control-soft" placeholder="Masukkan Username">
                  </div>
                </div>
             </div>
             ...
             <div class="col-md-12">
                <div class="form-group">
                  <label>Password</label>
                   <input v-model="password" id="inputPassword" type="password" class="form-control-soft" placeholder="Masukkan Password">
                  </div>
                </div>
             </div>
          ...
          <div class="row">
            <div class="update ml-auto mr-auto">
              ...
              <button block @click="$bvModal.hide('modal_user')" class="btn bg-gradient-dark w-auto me-2 pull-left"> Cancel </button>
            </div>                         
          </div>
        </form>
      </b-modal>
    ...
    methods: {
        ...
        Save: function(){
            ...
            if(this.action == "insert"){
                ...
                axios.put(base_url + 'user/' + this.id_user, form, config)
                .then( response => {
